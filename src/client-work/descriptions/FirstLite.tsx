  ...
  return (
    <div className="smith-description">
      <div>
          ...
          <div className="image"><motion.img src="../images/firstlite-1.png" whileTap={{scale: 2, zIndex: 5}}/></div>
      </div>

      <div>
        <div className="image"><motion.img src="../images/firstlite-2.png" whileTap={{scale: 2, zIndex: 5}}/></div>
        <div className="content">
            <h3>Development</h3>
            <p>
